...
const Radar = function(size, radar) {
  ...
  function createHomeLink(pageElement) {
    if (pageElement.select(".home-link").empty()) {
      pageElement
        ...
        .html("&#171; Voltar à página inicial do Radar")
  ...
  function plotRadarHeader() {
    ...
    header
      ...
      .html(
        '<a href="https://redentor.edu.br"> <img src="/images/logo.png" /> </a>'
      );
  ...
  function plotAlternativeRadars(alternatives, currentSheet) {
    ...
    alternativeSheetButton
      .append("p")
      .text("Escolha uma planilha para preencher o radar");
